...
<section class="section" id="motor"><div class="shell"><h2 class="section-title">Motor interactivo validado</h2><p class="lead">El motor inferior utiliza un dataset sintético neutral para demostrar estados, excepciones, aprobación humana, preentrada ERP simulada, idempotencia, recovery y auditoría. La personalización comercial permanece fuera del árbol React para preservar fiabilidad.</p><div class="actions"><a class="btn primary" href="/" target="_blank" rel="noopener noreferrer">Abrir motor a pantalla completa</a><a class="btn secondary" href="#motor">Ver aquí</a></div><p class="note">Nota técnica: no se transmiten pedidos ni datos a {name}. Las integraciones externas de esta demostración son simuladas.</p><iframe class="demo-frame" src="/" title="Motor interactivo OrderFlow con datos sintéticos" loading="lazy" referrerpolicy="no-referrer"></iframe></div></section>
